...
@section('content')
  <div class="container">
    <h1 class="my-4">Add a new artwork</h1>
    ...
    <form action="{{ route('artworks.store') }}" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name"
          value="{{ old('name') }}" placeholder="Add artwork name">
        @error('name')
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('artist_id') is-invalid @enderror" name="artist_id"
          id="artist_id" value="{{ old('artist_id') }}" placeholder="Add artist id">
        @error('artist_id')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('museum_id') is-invalid @enderror" name="museum_id"
          id="museum_id" value="{{ old('museum_id') }}" placeholder="Add museum id">
        @error('museum_id')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control @error('year') is-invalid @enderror" name="year" id="year"
          value="{{ old('year') }}" placeholder="Add year">
        @error('year')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
